...
while a<1 or a>95 :
    a = int(input('a: '))
    if a<1 or a>95 :
        print('reponse non valable') 
while b<a or b>96 :      
    b = int(input('b: '))
    if b<a or b>96:
        print('reponse non valable')

print("Choisi à combien de question tu shouaites répondre")
q = int(input('Nombres de questions: '))

for i in range(q):
    new = randrange(a,b,1)     #département choisi aléatoirement dans l'intervalle donné
    if new != last:
        last = new
